within ;
package Material "Base data records"
  extends Modelica.Icons.MaterialPropertiesPackage;
  package Roschke "Roschke: fractional mu_r(B)"
    extends Modelica.Icons.MaterialPropertiesPackage;
    record BaseData "Coefficients for approximation of soft magnetic materials"
      ...
      parameter Modelica.Units.SI.RelativePermeability mu_i=1
        "Initial relative permeability at B=0";
      parameter Modelica.Units.SI.MagneticFluxDensity B_myMax=1
  ...
  package SSEE "Smoothing Splines + Exponential Extrapolation"
    extends Modelica.Icons.MaterialPropertiesPackage;
    record BaseData "CastIron"
      ...
      parameter Modelica.Units.SI.MagneticFluxDensity BRef=1.5
        "Ref. flux density for spec. losses";
      parameter Modelica.Units.SI.Frequency fRef=50
        "Ref. frequency for spec. losses";
      parameter Modelica.Units.SI.Density dens=7500 "Density of material";
      parameter Modelica.Units.SI.RelativePermeability mu_ri=155.80
        "Initial relative permeability";
      // Exponential Extrapolation
      parameter Integer k0                    =     12    "Start of EE"
        annotation(Dialog(group="Exponential Extrapolation"));
      parameter Modelica.Units.SI.MagneticFieldStrength Hpar=9901.06
        "Parameter of EE" annotation (Dialog(group="Exponential Extrapolation"));
      parameter Modelica.Units.SI.MagneticFieldStrength Hsat=132113.5
        "Saturation field strength"
        annotation (Dialog(group="Exponential Extrapolation"));
      parameter Modelica.Units.SI.MagneticPolarization Jsat=1.27765
        "Saturation polarization"
        annotation (Dialog(group="Exponential Extrapolation"));
      // Homotopy
      parameter Modelica.Units.SI.MagneticFieldStrength hH1=5000.00
        "Start of homotopy" annotation (Dialog(group="Homotopy"));
      parameter Modelica.Units.SI.MagneticFieldStrength hH2=15000.00
        "End   of homotopy" annotation (Dialog(group="Homotopy"));
      // Length of Raw Data
      ...
      parameter Modelica.Units.SI.MagneticFieldStrength HD[:]={0.00,200.00,400.00,
          700.00,800.00,1000.00,1250.00,1400.00,1550.00,1750.00,2000.00,3000.00,
          4000.00,5000.00,6000.00,7000.00,8500.00,10000.00,12000.00,14000.00,
          16500.00,20000.00} annotation (Dialog(tab="Raw Data"));
      parameter Modelica.Units.SI.MagneticPolarization JD[:]={0.00000,0.03975,
          0.08648,0.18946,0.23053,0.31286,0.40582,0.45346,0.49471,0.54053,0.58552,
          0.68911,0.74949,0.79929,0.84394,0.88449,0.93858,0.98555,1.03870,1.08274,
          1.12733,1.17451} annotation (Dialog(tab="Raw Data"));
      annotation(defaultComponentPrefixes="parameter",
